...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton.setGeometry(QtCore.QRect(10, 430, 50, 40))
        self.pushButton.setMinimumSize(QtCore.QSize(50, 40))
        self.pushButton.setMaximumSize(QtCore.QSize(50, 40))
        self.pushButton.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/ui_imgs/icons/left.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton.setIcon(icon1)
        self.pushButton.setIconSize(QtCore.QSize(40, 40))
        self.pushButton.setObjectName("pushButton")
        self.pushButton_2 = QtWidgets.QPushButton(self.frame_2)
        self.pushButton_2.setGeometry(QtCore.QRect(710, 430, 50, 40))
        self.pushButton_2.setMinimumSize(QtCore.QSize(50, 40))
        self.pushButton_2.setMaximumSize(QtCore.QSize(50, 40))
        self.pushButton_2.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/ui_imgs/icons/right.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.groupBox.setGeometry(QtCore.QRect(0, 0, 431, 201))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        font.setPointSize(16)
        ...
        self.checkBox.setGeometry(QtCore.QRect(10, 120, 241, 31))
        font = QtGui.QFont()
        font.setFamily("仿宋")
        font.setPointSize(16)
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 90, 201, 31))
        ...
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(220, 90, 201, 31))
        ...
        self.checkBox_2.setGeometry(QtCore.QRect(270, 120, 111, 31))
        font = QtGui.QFont()
        font.setFamily("仿宋")
        font.setPointSize(16)
        ...
        self.layoutWidget_4.setGeometry(QtCore.QRect(10, 150, 401, 38))
        ...
        self.horizontalLayoutWidget_3.setGeometry(QtCore.QRect(10, 40, 401, 40))
        ...
        self.PicBtn_2 = QtWidgets.QPushButton(self.horizontalLayoutWidget_3)
        self.PicBtn_2.setMinimumSize(QtCore.QSize(0, 0))
        self.PicBtn_2.setMaximumSize(QtCore.QSize(300, 30))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        font.setPointSize(16)
        self.PicBtn_2.setFont(font)
        self.PicBtn_2.setToolTipDuration(2)
        self.PicBtn_2.setStyleSheet("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/ui_imgs/icons/models.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.PicBtn_2.setIcon(icon3)
        self.PicBtn_2.setIconSize(QtCore.QSize(30, 30))
        self.PicBtn_2.setObjectName("PicBtn_2")
        self.horizontalLayout_13.addWidget(self.PicBtn_2)
        self.groupBox_2 = QtWidgets.QGroupBox(self.frame_4)
        self.groupBox_2.setGeometry(QtCore.QRect(0, 200, 431, 281))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        font.setPointSize(16)
        ...
        self.frame_6.setGeometry(QtCore.QRect(0, 170, 431, 191))
        self.frame_6.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_6.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_6.setObjectName("frame_6")
        self.label_4 = QtWidgets.QLabel(self.frame_6)
        self.label_4.setGeometry(QtCore.QRect(20, 0, 131, 21))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(16)
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(20, 30, 161, 37))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(210, 30, 161, 37))
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(20, 70, 161, 37))
        ...
        self.layoutWidget3.setGeometry(QtCore.QRect(210, 70, 161, 37))
        ...
        self.layoutWidget6.setGeometry(QtCore.QRect(210, 120, 191, 41))
        ...
        self.layoutWidget_3.setGeometry(QtCore.QRect(10, 120, 191, 41))
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/ui_imgs/icons/video.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/ui_imgs/icons/camera.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.CapBtn.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/ui_imgs/icons/保存.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icons/ui_imgs/icons/退出.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icons/ui_imgs/icons/img.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.PicBtn.setIcon(icon9)
        ...
        self.label_3.setGeometry(QtCore.QRect(20, 0, 1201, 51))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "基于深度学习药品流水线封装状态检测系统"))
        ...
        self.checkBox_2.setText(_translate("MainWindow", "显示原图"))
        self.label_16.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">检测设备选择：</span></p></body></html>"))
        self.label_17.setText(_translate("MainWindow", "<html><head/><body><p>选择检测模型：</p></body></html>"))
        self.PicBtn_2.setText(_translate("MainWindow", "选择模型"))
        self.groupBox_2.setTitle(_translate("MainWindow", "检测结果"))
        self.label_4.setText(_translate("MainWindow", "<html><head/><body><p>目标位置：</p></body></html>"))
        ...
        self.label_3.setText(_translate("MainWindow", "基于深度学习药品流水线封装状态检测系统"))
        self.label_2.setText(_translate("MainWindow", "齐鲁理工"))
        self.label_12.setText(_translate("MainWindow", "赵振涵"))
